package com.example.ajax.infractucture.bpp

import com.example.ajax.infractucture.dto.Identifiable
import com.example.ajax.infractucture.email.EmailSenderService
...
class NotificationInvocationHandler(
    ...
    private fun createNotification(identifiable: Identifiable) {
        val mongoGroupChatRoomRepositoryInPort = beanFactory.getBean(MongoGroupChatRoomRepositoryInPort::class.java)
        ...
        val chatMono = mongoGroupChatRoomRepositoryInPort.findChatRoom(identifiable.chatRoomId).cache()
